...
const layerConfigs = [
    ...
    },
    {
        ...
        layerVisibilityDefault: true,
        metadata: {
            url: 'data/Segara-Lestari-Drone-Scan-higher-altitude-2025-07-16-orthophoto.raw.cog.tif',
    ...
    },
    {
        ...
        layerVisibilityDefault: true,
        metadata: {
            url: 'data/Segara-Lestari-Drone-Scan-lower-altitude-2025-07-16-orthophoto.raw.cog.tif',
            contributedOn: '2025-07-16',
            contributedBy: 'Ben / Andy',
        }
    },
    {
        ...
        layerVisibilityDefault: true,
        metadata: {
            url: 'data/2025-07-dinacon-drone-sea-1.cog.tif',
    ...
    },
    {
        ...
        layerVisibilityDefault: true,
        metadata: {
            url: 'data/2025-07-dinacon-drone-sea-2.cog.tif',
            contributedOn: '2025-07-09',
            contributedBy: 'Logan',
        }
    },
    {
        ...
        layerVisibilityDefault: true,
        metadata: {
            url: 'data/2025-07-dinacon-alison-coral-tables.cog.tif',
            contributedOn: '2025-07-09',
