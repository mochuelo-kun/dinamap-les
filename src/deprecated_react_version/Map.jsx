...
const MapComponent = ({ 
  ...
  }, [homeLatLng, homeZoom, layers], ['homeLatLng', 'homeZoom', 'layers'], 'INITIAL MAP MOUNT');
  ...
  // }, [layers, map]);
  }, [layers, map], ['layers', 'map'], 'LAYER VISIBILITY CHANGE');
  ...
  }, [clickCoordinates, map, coordinateMarkerLayer], ['clickCoordinates', 'map', 'coordinateMarkerLayer'], 'ORIGINAL COORDINATE CLICK');
  ...
  }, [searchCoordinates, map], ['searchCoordinates', 'map'], 'SEARCH / FLY TO');
  ...
  }, [map, onFeatureClick, featuresGeoJSON], ['map', 'onFeatureClick', 'featuresGeoJSON'], 'FEATURE MANAGER MAP CLICKS');
  ...
  }, [featureLayer, featuresGeoJSON], ['featureLayer', 'featuresGeoJSON'], 'GEOJSON CHANGES');
